...
namespace Microsoft.CodeAnalysis.CSharp
{
    internal enum BoundKind: byte
    {
        ...
        BackingFieldsForPrimaryConstructorParametersInitialization,
    }
    ...
    {
        public BoundObjectInitializerMember(CSharpSyntaxNode syntax, Symbol memberSymbol, ImmutableArray<BoundExpression> arguments, LookupResultKind resultKind, TypeSymbol type, bool hasErrors = false)
        ...
        public BoundObjectInitializerMember Update(Symbol memberSymbol, ImmutableArray<BoundExpression> arguments, LookupResultKind resultKind, TypeSymbol type)
        {
            if (memberSymbol != this.MemberSymbol || arguments != this.Arguments || resultKind != this.ResultKind || type != this.Type)
            {
                var result = new BoundObjectInitializerMember(this.Syntax, memberSymbol, arguments, resultKind, type, this.HasErrors);
                result.WasCompilerGenerated = this.WasCompilerGenerated;
                return result;
            }
            return this;
    ...
    internal sealed partial class BoundBackingFieldsForPrimaryConstructorParametersInitialization : BoundStatement
    {
        public BoundBackingFieldsForPrimaryConstructorParametersInitialization(CSharpSyntaxNode syntax, bool hasErrors)
            : base(BoundKind.BackingFieldsForPrimaryConstructorParametersInitialization, syntax, hasErrors)
        {
        }

        public BoundBackingFieldsForPrimaryConstructorParametersInitialization(CSharpSyntaxNode syntax)
            : base(BoundKind.BackingFieldsForPrimaryConstructorParametersInitialization, syntax)
        {
        }
        ...
        public override BoundNode Accept(BoundTreeVisitor visitor)
        {
            return visitor.VisitBackingFieldsForPrimaryConstructorParametersInitialization(this);
        }
    }
    ...
    internal abstract partial class BoundTreeVisitor<A,R>
    {
        ...
        internal R VisitInternal(BoundNode node, A arg)
        {
            switch (node.Kind)
            {
                ...
                case BoundKind.BackingFieldsForPrimaryConstructorParametersInitialization: 
                    return VisitBackingFieldsForPrimaryConstructorParametersInitialization(node as BoundBackingFieldsForPrimaryConstructorParametersInitialization, arg);
            }
    ...
    internal abstract partial class BoundTreeVisitor<A,R>
    {
        ...
        public virtual R VisitBackingFieldsForPrimaryConstructorParametersInitialization(BoundBackingFieldsForPrimaryConstructorParametersInitialization node, A arg)
        {
            return this.DefaultVisit(node, arg);
        }
    }
    ...
    internal abstract partial class BoundTreeVisitor
    {
        ...
        public virtual BoundNode VisitBackingFieldsForPrimaryConstructorParametersInitialization(BoundBackingFieldsForPrimaryConstructorParametersInitialization node)
        {
            return this.DefaultVisit(node);
        }
    }
    ...
    internal abstract partial class BoundTreeRewriter : BoundTreeVisitor
    {
        ...
        public override BoundNode VisitObjectInitializerMember(BoundObjectInitializerMember node)
        {
            ImmutableArray<BoundExpression> arguments = (ImmutableArray<BoundExpression>)this.VisitList(node.Arguments);
            TypeSymbol type = this.VisitType(node.Type);
            return node.Update(node.MemberSymbol, arguments, node.ResultKind, type);
        }
        public override BoundNode VisitDynamicObjectInitializerMember(BoundDynamicObjectInitializerMember node)
        {
            TypeSymbol type = this.VisitType(node.Type);
    ...
    internal sealed class BoundTreeDumperNodeProducer : BoundTreeVisitor<object, TreeDumperNode>
    {
        ...
        public override TreeDumperNode VisitBackingFieldsForPrimaryConstructorParametersInitialization(BoundBackingFieldsForPrimaryConstructorParametersInitialization node, object arg)
        {
            return new TreeDumperNode("backingFieldsForPrimaryConstructorParametersInitialization", null, new TreeDumperNode[]
            {
            }
            );
        }
